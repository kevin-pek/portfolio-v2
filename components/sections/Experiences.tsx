...
export const Experiences = () => {
  return (
    <div className="flex flex-col gap-6 px-4 md:px-24">
      ...
      <Accordion title="Data Scientist Intern @ GovTech" skills={["Python", "FastAPI", "PyTorch", "PaddlePaddle", "sklearn", "Deep Learning", "AWS", "Docker"]}>
      ...
      <Accordion title="Research Assistant @ NUS IORA, NCS" skills={["Python", "Data Analysis", "Azure", "Finite Volume Method", "FiPy", "PyTorch"]}>
      ...
      <Accordion title="Research Assistant @ NUS IORA, SIA" skills={["Typescript", "Express", "React", "Docker", "Python", "FastAPI", "Multi-armed Bandits"]}>
