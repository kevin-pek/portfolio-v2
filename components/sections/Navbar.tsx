...
export const Navbar: FC = () => {
  return (
    <div className="fixed inset-x-0 z-40 mx-auto w-full border-2 border-neutral bg-base-200 bg-opacity-50 sm:mt-4 sm:w-fit sm:rounded-full" style={{ backdropFilter: "blur(16px)" }}>
      {/* hidden checkbox that controls the drawer */}
      <input id="nav-drawer" type="checkbox" className="drawer-toggle" />

      {/* Desktop device */}
      <ul className="menu menu-horizontal flex w-full flex-row items-center justify-between p-0 pl-2" style={{ paddingRight: "-4px" }}>
